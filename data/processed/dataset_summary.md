...
- **Total Events**: `140,001`
- **Date Range**: `2026-05-31 23:22:00 UTC` to `2026-06-29 23:29:39 UTC` (`21` days)
- **Total Monitored Entities**: `400` (Users, Service Accounts, Edge Devices)
- **Total Tracked Sessions**: `9,575`
...
| :--- | :--- | :--- |
| **Normal Traffic (`is_malicious=False`)** | `139,418` | `99.58%` |
| **Malicious Traffic (`is_malicious=True`)** | `583` | `0.42%` |
| **Total** | `140,001` | `100.00%` |
...
| :--- | :---: | :---: | :---: | :--- |
| `credential_misuse` | `7` | `51` | `True` | Off-hours sensitive cross-department resource access under valid user credentials |
| `brute_force` | `7` | `161` | `True` | Burst of failed logons followed by 1 successful logon & unauthorized access |
...
| `credential_stuffing` | `7` | `182` | `True` | MANY entity IDs attempting auth from FEW shared attacker IPs with high failure rate |
| `low_and_slow_exfiltration` | `7` | `112` | `True` | Gradual, small off-hours resource access building up incrementally over weeks |
